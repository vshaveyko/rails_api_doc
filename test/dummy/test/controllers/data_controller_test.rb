...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post data_url, params: { datum: { comment: @datum.comment, creation_date: @datum.creation_date } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { comment: @datum.comment, creation_date: @datum.creation_date } }
